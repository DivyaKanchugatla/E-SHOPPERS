              ...
              <div className="col-lg-3 col-md-6 col-sm-12">
                <div className="border mb-4">
                  <div key={each.id}>
                    ...
                    <div className="trandy-product-title-container">
                      <h5 className="trandy-product-title">{each.title}</h5>
                      <div className="trandy-price-container">
                        <h4 className="trandy-product-price mr-2">${each.price}.00</h4>
                        <h4 className="trandy-product-cross-price">
                          ${each.cross_price}.00
                        </h4>
                      </div>
                    </div>
                    <hr className="hr-line" />
                    <div className="trandy-bottom-card-container">
                      <div className="trandy-bottom-button">
                        <svg
                          className="trandy-eye-cart-icon"
                        ...
                        <button className="trandy-view-add-button">View Detail</button>
                      </div>
                      <div>
                        <div className="trandy-bottom-button">
                          <svg
                          ...
                          <button className="trandy-view-add-button">Add To Cart</button>
                        </div>
                      </div>
                    </div>
                  </div>
