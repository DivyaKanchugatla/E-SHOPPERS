                ...
                <div className="border mb-4">
                  <div key={index}>
                    <div className="just-card">
                      <img
                        src={each.imgSrc}
                        className="just-product-picture"
                        alt={each.title}
                      />
                    </div>
                    <hr className="hr-line" />
                    <div className="just-product-title-container">
                      <h5 className="just-product-title">{each.title}</h5>
                      <div className="just-price-container">
                        <h4 className="just-product-price mr-2">${each.price}.00</h4>
                        <h4 className="just-product-cross-price">
                          ${each.cross_price}.00
                        </h4>
                      </div>
                    </div>
                    <hr className="hr-line" />
                    <div className="just-bottom-card-container">
                      <div className="just-bottom-button">
                        <svg
                          className="just-eye-cart-icon"
                        ...
                        <button className="just-view-add-button">View Detail</button>
                      </div>
                      <div>
                        <div className="just-bottom-button">
                          <svg
                          ...
                          <button className="just-view-add-button">Add To Cart</button>
                        </div>
                      </div>
                    </div>
                  </div>
